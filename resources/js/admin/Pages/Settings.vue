      ...
      <el-tabs v-model="activeTab">
        ...
        <el-tab-pane label="Advanced" name="advanced">
          ...
          <el-card>
            <div class="p-4">
              <el-alert
                title="Warning: These settings are for advanced users only."
                type="warning"
                :closable="false"
                class="mb-4"
              />
              
              <el-form :model="settings.advanced" label-position="top" ref="advancedForm">
                <el-form-item label="Custom CSS">
                  <el-input type="textarea" v-model="settings.advanced.customCss" rows="5" placeholder="Enter custom CSS"></el-input>
                </el-form-item>
                
                <el-form-item label="Custom JavaScript">
                  <el-input type="textarea" v-model="settings.advanced.customJs" rows="5" placeholder="Enter custom JavaScript"></el-input>
                </el-form-item>
                
                <el-form-item label="API Key">
                  <el-input v-model="settings.advanced.apiKey" placeholder="API Key"></el-input>
                  <div class="text-gray-500 text-sm mt-1">Leave blank to use the default API key</div>
                </el-form-item>
                
                <el-form-item>
                  <el-button type="primary" @click="saveSettings('advanced')">Save Advanced Settings</el-button>
                </el-form-item>
              </el-form>
            </div>
          </el-card>
